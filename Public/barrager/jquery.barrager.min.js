...
!function (a)
{
    a.fn.barrager = function (b)
    {
        ...
        b.img && (div_barrager_box.append("<a class='portrait z' href='javascript:;'></a>"), i = a("<img src='' >").appendTo(e + " .barrage_box .portrait"), i.attr("src", b.img)),
        div_barrager_box.append(" <div class='z p'></div>"),
        b.close && div_barrager_box.append(" <div class='close z'></div>"),
        j = a("<a title='' target='_blank'></a>").appendTo(e + " .barrage_box .p"),
        j.attr(
        {
            // href : b.href,
            id : b.id
        ...
        navigator.userAgent.indexOf("MSIE 6.0") > 0 || navigator.userAgent.indexOf("MSIE 7.0") > 0 || navigator.userAgent.indexOf("MSIE 8.0") > 0 ? j.css("color", b.old_ie_color) : j.css("color", b.color),
        k = 0,
